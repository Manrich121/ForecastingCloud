...
def performEvaluations(filename, train_window = 3000, overload_dur = 5, overload_percentile = 70, steps=30):
    cur_results = []
    forecasts = np.genfromtxt("d:/data/diskio_markov2_forecasts/"+ filename,delimiter=',',usecols=range(0,steps)).ravel()
...
if __name__ == '__main__':
    ...
    fileutils.writeCSV("d:/data/results/diskio_markov2.csv", results)