...
def performEvaluations(filename, train_window = 3000, overload_dur = 5, overload_percentile = 70, steps=30):
    cur_results = []
    forecasts = np.genfromtxt("d:/data/memory_wavelet_forecasts/"+ filename,delimiter=',',usecols=range(0,steps)).ravel()
...
if __name__ == '__main__':
    ...
    fileutils.writeCSV("d:/data/results/memory_wavelet.csv", results)